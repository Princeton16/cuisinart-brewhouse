...
const DATA = {
  ...
  members: [
    { id: 'maya-r', name: 'Maya R.', handle: '@maya.brews', initials: 'MR', tier: 'specialty', tierIcon: '🌊', points: 4830, streak: 28, brews: 312, location: 'Portland, Oregon, United States', personality: 'methodical', bio: 'Pour over obsessed. V60 evangelist.', avatarBg: 'linear-gradient(135deg, #C8762D 0%, #A85F1F 100%)', recentBrew: 'Onyx Monarch · V60' },
    { id: 'diego-p', name: 'Diego P.', handle: '@diego.pulls', initials: 'DP', tier: 'specialty', tierIcon: '🌊', points: 4210, streak: 41, brews: 298, location: 'Mexico City, Mexico', personality: 'creator', bio: 'Latte art every morning. Try my hibiscus syrup.', avatarBg: 'linear-gradient(135deg, #2D4A3A 0%, #1d3327 100%)', recentBrew: 'Hibiscus latte · espresso' },
    ...
    { id: 'alex-t', name: 'Alex T.', handle: '@alex.morning', initials: 'AT', tier: 'home-barista', tierIcon: '☕', points: 3120, streak: 14, brews: 187, location: 'Brooklyn, New York, United States', personality: 'comfort', bio: 'Same machine every morning. No notes.', avatarBg: 'linear-gradient(135deg, #5476A6 0%, #2c4869 100%)', recentBrew: 'Counter Culture · drip' },
    { id: 'sam-k', name: 'Sam K.', handle: '@sam.steams', initials: 'SK', tier: 'home-barista', tierIcon: '☕', points: 2890, streak: 8, brews: 142, location: 'Toronto, Ontario, Canada', personality: 'creator', bio: 'Day 14 of 30 Days of Latte Art. Hearts holding steady.', avatarBg: 'linear-gradient(135deg, #4A3A30 0%, #2A1A14 100%)', recentBrew: 'Cappuccino · espresso' },
    { id: 'jordan-w', name: 'Jordan W.', handle: '@jordan.cafe', initials: 'JW', tier: 'home-barista', tierIcon: '☕', points: 2540, streak: 21, brews: 156, location: 'Austin, Texas, United States', personality: 'social', bio: 'Coffee shop tour videos. Brooklyn next month.', avatarBg: 'linear-gradient(135deg, #6B5D54 0%, #3D2418 100%)', recentBrew: 'Iced flat white' },
    ...
    { id: 'marcus-b', name: 'Marcus B.', handle: '@marcus.learns', initials: 'MB', tier: 'apprentice', tierIcon: '🌱', points: 1840, streak: 4, brews: 38, location: 'Chicago, Illinois, United States', personality: 'methodical', bio: 'Just got my first espresso machine. Learning fast.', avatarBg: 'linear-gradient(135deg, #2D4A3A 0%, #C5962B 100%)', recentBrew: 'Espresso · dialing in' },
