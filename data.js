...
const DATA = {
  ...
  cafes: [
    { id: 'dirt-cowboy',     name: 'Dirt Cowboy Cafe',         short: 'Dirt Cowboy',     hood: 'Hanover, New Hampshire',     city: 'Hanover',       state: 'New Hampshire',  roaster: 'Counter Culture',     topMatch: false, coords: [43.7022,  -72.2896], drinks: ['Pour-over', 'Espresso', 'Cappuccino'],                  photoUrl: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80', status: 'active' },
    { id: 'the-works',       name: 'The Works Bakery Cafe',    short: 'The Works',       hood: 'Hanover, New Hampshire',     city: 'Hanover',       state: 'New Hampshire',  roaster: 'Green Mountain Coffee',topMatch: false, coords: [43.7018,  -72.2898], drinks: ['Drip', 'Latte', 'Mocha'],                                photoUrl: 'https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=400&q=80', status: 'soon'   },
    { id: 'umplebys',        name: "Umpleby's Bakery & Cafe",  short: "Umpleby's",       hood: 'Norwich, Vermont',           city: 'Norwich',       state: 'Vermont',        roaster: 'Vermont Coffee Co.', topMatch: false, coords: [43.7155,  -72.3057], drinks: ['Drip', 'Cappuccino', 'Cold brew'],                       photoUrl: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&q=80', status: 'soon'   },
    { id: 'joe-coffee',      name: 'Joe Coffee Company',       short: 'Joe Coffee',      hood: 'New York, New York',         city: 'New York',      state: 'New York',       roaster: 'Joe Coffee Company', topMatch: false, coords: [40.7335,  -74.0027], drinks: ['Espresso', 'Latte', 'Cold brew'],                        photoUrl: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=400&q=80', status: 'soon'   },
    { id: 'counter-culture', name: 'Counter Culture Coffee',   short: 'Counter Culture', hood: 'Durham, North Carolina',     city: 'Durham',        state: 'North Carolina', roaster: 'Counter Culture Coffee', topMatch: true,  coords: [35.9293,  -78.8794], drinks: ['Pour-over', 'Espresso', 'Cappuccino'],                   photoUrl: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=400&q=80', status: 'soon'   },
    { id: 'intelligentsia',  name: 'Intelligentsia Coffee',    short: 'Intelligentsia',  hood: 'Chicago, Illinois',          city: 'Chicago',       state: 'Illinois',       roaster: 'Intelligentsia Coffee', topMatch: true,  coords: [41.9081,  -87.7079], drinks: ['Black Cat espresso', 'Pour-over', 'Cortado'],            photoUrl: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=400&q=80', status: 'soon'   },
    { id: 'sweet-bloom',     name: 'Sweet Bloom Coffee',       short: 'Sweet Bloom',     hood: 'Lakewood, Colorado',         city: 'Lakewood',      state: 'Colorado',       roaster: 'Sweet Bloom Coffee', topMatch: false, coords: [39.7392, -105.0844], drinks: ['Pour-over', 'Espresso', 'Cortado'],                      photoUrl: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=400&q=80', status: 'soon'   },
    { id: 'cuvee',           name: 'Cuvée Coffee Bar',         short: 'Cuvée',           hood: 'Austin, Texas',              city: 'Austin',        state: 'Texas',          roaster: 'Cuvée Coffee',       topMatch: false, coords: [30.2625,  -97.7295], drinks: ['Black & White', 'Cold brew', 'Latte'],                   photoUrl: 'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?w=400&q=80', status: 'soon'   },
    { id: 'stumptown',       name: 'Stumptown Coffee',         short: 'Stumptown',       hood: 'Portland, Oregon',           city: 'Portland',      state: 'Oregon',         roaster: 'Stumptown Coffee',   topMatch: true,  coords: [45.5230, -122.6760], drinks: ['Hair Bender espresso', 'Cold brew', 'Pour-over'],        photoUrl: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=400&q=80', status: 'soon'   },
    { id: 'blue-bottle',     name: 'Blue Bottle Coffee',       short: 'Blue Bottle',     hood: 'San Francisco, California',  city: 'San Francisco', state: 'California',     roaster: 'Blue Bottle Coffee', topMatch: true,  coords: [37.7820, -122.4079], drinks: ['New Orleans iced coffee', 'Gibraltar', 'Pour-over'],     photoUrl: 'https://images.unsplash.com/photo-1507133750040-4a8f57021571?w=400&q=80', status: 'soon'   },
    { id: 'sey',             name: 'Sey Coffee',               short: 'Sey',             hood: 'Brooklyn, New York',          city: 'Brooklyn',      state: 'New York',       roaster: 'Sey Coffee',          topMatch: true,  coords: [40.7128,  -73.9446], drinks: ['Pour-over', 'Espresso', 'Drip'],                          photoUrl: 'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?w=400&q=80', status: 'soon'   },
    { id: 'devocion',        name: 'Devoción',                 short: 'Devoción',        hood: 'Brooklyn, New York',          city: 'Brooklyn',      state: 'New York',       roaster: 'Devoción',           topMatch: true,  coords: [40.7163,  -73.9598], drinks: ['Espresso', 'Pour-over', 'Cortado'],                       photoUrl: 'https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=400&q=80', status: 'soon'   },
    { id: 'la-colombe',      name: 'La Colombe',               short: 'La Colombe',      hood: 'Philadelphia, Pennsylvania',  city: 'Philadelphia',  state: 'Pennsylvania',   roaster: 'La Colombe',          topMatch: false, coords: [39.9522,  -75.1444], drinks: ['Draft latte', 'Espresso', 'Cold brew'],                   photoUrl: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=400&q=80', status: 'soon'   },
    { id: 'george-howell',   name: 'George Howell Coffee',     short: 'George Howell',   hood: 'Boston, Massachusetts',       city: 'Boston',        state: 'Massachusetts',  roaster: 'George Howell',       topMatch: true,  coords: [42.3554,  -71.0606], drinks: ['Pour-over', 'Espresso', 'Latte'],                         photoUrl: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=400&q=80', status: 'soon'   },
    { id: 'octane',          name: 'Octane Coffee',            short: 'Octane',          hood: 'Atlanta, Georgia',            city: 'Atlanta',       state: 'Georgia',        roaster: 'Octane Coffee Bar',   topMatch: false, coords: [33.7553,  -84.3940], drinks: ['Pour-over', 'Cortado', 'Espresso'],                       photoUrl: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=400&q=80', status: 'soon'   },
    { id: 'panther-miami',   name: 'Panther Coffee',           short: 'Panther',         hood: 'Miami, Florida',              city: 'Miami',         state: 'Florida',        roaster: 'Panther Coffee',      topMatch: true,  coords: [25.8005,  -80.1991], drinks: ['Cortado', 'Espresso', 'Cold brew'],                       photoUrl: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&q=80', status: 'soon'   },
    { id: 'spyhouse',        name: 'Spyhouse Coffee',          short: 'Spyhouse',        hood: 'Minneapolis, Minnesota',      city: 'Minneapolis',   state: 'Minnesota',      roaster: 'Spyhouse Coffee',     topMatch: false, coords: [44.9728,  -93.2738], drinks: ['Pour-over', 'Latte', 'Drip'],                             photoUrl: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80', status: 'soon'   },
    { id: 'ruby',            name: 'Ruby Coffee',              short: 'Ruby',            hood: 'Madison, Wisconsin',          city: 'Madison',       state: 'Wisconsin',      roaster: 'Ruby Coffee',         topMatch: false, coords: [43.0731,  -89.4012], drinks: ['Pour-over', 'Cappuccino', 'Espresso'],                    photoUrl: 'https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=400&q=80', status: 'soon'   },
    { id: 'kaldi',           name: 'Kaldi’s Coffee',           short: 'Kaldi’s',         hood: 'St. Louis, Missouri',         city: 'St. Louis',     state: 'Missouri',       roaster: 'Kaldi’s Coffee',      topMatch: false, coords: [38.6432,  -90.2615], drinks: ['Pour-over', 'Latte', 'Cortado'],                          photoUrl: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=400&q=80', status: 'soon'   },
    { id: 'verve',           name: 'Verve Coffee',             short: 'Verve',           hood: 'Los Angeles, California',     city: 'Los Angeles',   state: 'California',     roaster: 'Verve Coffee',        topMatch: true,  coords: [34.0900, -118.3617], drinks: ['Streetlevel espresso', 'Pour-over', 'Cortado'],           photoUrl: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=400&q=80', status: 'soon'   },
    { id: 'heart',           name: 'Heart Coffee',             short: 'Heart',           hood: 'Portland, Oregon',            city: 'Portland',      state: 'Oregon',         roaster: 'Heart Roasters',      topMatch: false, coords: [45.5230, -122.6464], drinks: ['Pour-over', 'Espresso', 'Cortado'],                       photoUrl: 'https://images.unsplash.com/photo-1453614512568-c4024d13c247?w=400&q=80', status: 'soon'   },
    { id: 'analog',          name: 'Analog Coffee',            short: 'Analog',          hood: 'Seattle, Washington',         city: 'Seattle',       state: 'Washington',     roaster: 'Analog Coffee',       topMatch: false, coords: [47.6261, -122.3232], drinks: ['Pour-over', 'Espresso', 'Drip'],                          photoUrl: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&q=80', status: 'soon'   },
    { id: 'bow-truss',       name: 'Bow Truss Coffee',         short: 'Bow Truss',       hood: 'Chicago, Illinois',           city: 'Chicago',       state: 'Illinois',       roaster: 'Bow Truss',           topMatch: false, coords: [41.9485,  -87.6610], drinks: ['Pour-over', 'Latte', 'Cold brew'],                        photoUrl: 'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?w=400&q=80', status: 'soon'   },
    { id: 'huckleberry',     name: 'Huckleberry Roasters',     short: 'Huckleberry',     hood: 'Denver, Colorado',            city: 'Denver',        state: 'Colorado',       roaster: 'Huckleberry',         topMatch: false, coords: [39.7591, -105.0178], drinks: ['Pour-over', 'Espresso', 'Cortado'],                       photoUrl: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&q=80', status: 'soon'   },
    { id: 'phoenix-cartel',  name: 'Cartel Coffee Lab',        short: 'Cartel',          hood: 'Phoenix, Arizona',            city: 'Phoenix',       state: 'Arizona',        roaster: 'Cartel Coffee Lab',   topMatch: false, coords: [33.4484, -112.0740], drinks: ['Pour-over', 'Espresso', 'Cold brew'],                     photoUrl: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=400&q=80', status: 'soon'   }
  ],
